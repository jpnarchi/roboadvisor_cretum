  ...
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      <div className="flex flex-col h-screen bg-black text-[#b9d6ee]">
        <header className="glass-panel px-3 sm:px-6 py-3 sm:py-4">
          <div className="flex items-center justify-between max-w-7xl mx-auto">
            {/* Logo and Title */}
            <div className="flex items-center gap-2 sm:gap-4">
              <img src="/menlog.svg" alt="CRETUM Partners Logo" className="h-8 w-auto sm:h-12" />
              <div>
                <h1 className="text-lg sm:text-2xl font-bold text-[#b9d6ee]">Robo Advisor</h1>
                <p className="text-xs sm:text-sm text-[#b9d6ee]">Passion Beyond Money</p>
              </div>
            </div>
            ...
            >
              {isMobileMenuOpen ? (
                <X className="w-6 h-6 text-[#b9d6ee]" />
              ) : (
                <Menu className="w-6 h-6 text-[#b9d6ee]" />
              )}
            </button>
          </div>
          ...
          {isMobileMenuOpen && (
            <div className="lg:hidden mt-4 space-y-3 border-t border-[#b9d6ee]/10 pt-4">
              {/* Search Bar */}
              <div className="relative">
                <input
                  ref={searchInputRef}
                  ...
                  placeholder="Buscar acción..."
                  className="w-full px-4 py-2 bg-black/50 text-[#b9d6ee] rounded-lg border border-[#b9d6ee]/20 focus:outline-none focus:border-[#b9d6ee]/50 pl-10"
                />
                <Search className="absolute left-3 top-1/2 transform -translate-y-1/2 w-4 h-4 text-[#b9d6ee]" />
              </div>
              ...
              {/* Last Update Info */}
              <div className="text-xs text-[#b9d6ee]/70">
                Last chart update: {lastUpdate}
              </div>
              ...
              <div className="flex flex-wrap gap-2">
                <button
                  onClick={handleUpdateData}
                  className="p-2 rounded-lg hover:bg-white/10 transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#b9d6ee] text-[#b9d6ee] bg-black/50"
                  title="Update Data"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                ...
                <button
                  onClick={exportStockData}
                  disabled={isExporting}
                  className="px-3 py-2 bg-[#b9d6ee]/10 hover:bg-[#b9d6ee]/20 text-[#b9d6ee] rounded-lg border border-[#b9d6ee]/20 transition-all duration-200 flex items-center gap-2 shadow-glow disabled:opacity-50 disabled:cursor-not-allowed text-sm"
                >
              ...
              <div className="flex gap-2">
                <button 
                  ...
                  className={`flex-1 px-3 py-2 rounded-lg button-glow text-sm ${
                    currentView === 'dashboard' 
                      ? 'bg-[#b9d6ee] text-black' 
                      : 'bg-black/50 text-[#b9d6ee] hover:text-white'
                  }`}
